...
import Brand from './images/favicon-p.png';
                ...
                <nav className="navbar navbar-expand-lg navbar-light bg-light">
                    <div className="container-fluid">
                        <NavLink className="navbar-brand" to="/">
                            <img style={{width : '80px'}} src={Brand} alt="brand" />
                        </NavLink>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav m-lg-auto mb-2 mb-lg-0">
                                <li className="nav-item">
                                    <NavLink exact activeClassName="menu_active" className="nav-link"
                                ...
                                <li className="nav-item">
                                    <NavLink exact activeClassName="menu_active" className="nav-link" to="/about">About
                                    </NavLink>
                                </li>
